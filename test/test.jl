...
l = 10.0
l1 = DeepGP.SVGPLayer(ngp, μ1, L1, Z, transform(SqExponentialKernel(), l), DeepGP.ZeroMean())
l2 = DeepGP.SVGPLayer(1, μ2, L2, rand(ndim, ngp), transform(SqExponentialKernel(), l), DeepGP.ZeroMean())
